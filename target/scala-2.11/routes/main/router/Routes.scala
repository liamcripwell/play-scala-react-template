...
class Routes(
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:15
    WebJarAssets_4: controllers.WebJarAssets
  ) = this(errorHandler, HomeController_1, CountController_0, AsyncController_2, Assets_3, WebJarAssets_4, "/")

  import ReverseRouteContext.empty

  def withPrefix(prefix: String): Routes = {
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_1, CountController_0, AsyncController_2, Assets_3, WebJarAssets_4, prefix)
  }
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_WebJarAssets_at4_route(params) =>
      call(params.fromPath[String]("file", None)) { (file) =>
        controllers_WebJarAssets_at4_invoker.call(WebJarAssets_4.at(file))
      }
  }
}
